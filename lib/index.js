...
/**
 * Creates a function which is used to instantiate the application
 *
 * @param {Object} pkg Contents of the package.json
 * @returns {Function} The main function to start the application
 */
module.exports = function createInstantiate(pkg) {
	 ...
	 * @returns {undefined}
	 */
	return function instantiate(action, options) {
